  ...
  <div>
    ...
    <div class="content-body">
      ...
      <div>
        ...
        <div class="row">
          <div class="form-row">
            <button type="button" class="btn btn-md line-1" @click="taxModal()">
              <span>세무대장 조회</span>
            </button>
          </div>
        </div>
        ...
        <salary-modal ref="salarymodal" @close="openTaxLedgerSelect($event)"/>
        <tax-ledger-modal ref="taxledgermodal"/>
      </div>
    </div>
  </div>
</template>
...
import TaxLedgerModal from "./TaxLedgerModal";
...
export default {
  ...
  methods: {
    ...
    openTaxLedgerSelect(param){
      this.$refs.taxledgermodal.show({formData:param.formData});
    }
  },
  mounted() {
