<template>
    <div>
        ...
        <acquisition-job-common-input-modal ref="acquisitionJobCommonInputModal" @loadGridData="loadGridData"/>
        <acquisition-job-annual-input-modal ref="acquisitionJobAnnualInputModal" @loadGridData="loadGridData"/>
        <acquisition-job-health-input-modal ref="acquisitionJobHealthInputModal" @loadGridData="loadGridData"/>
        <acquisition-job-employment-input-modal ref="acquisitionJobEmploymentInputModal" @loadGridData="loadGridData"/>
        <acquisition-job-industrial-ash-input-modal ref="acquisitionJobIndustrialAshInputModal" @loadGridData="loadGridData"/>
    </div>
</template>
<script>
import grid from '@/mixin/payroll-grid';
import gridData from '@/utils/declareGridData';
import AcquisitionJobCommonInputModal from '@/components/payroll/social_insurance/modal/AcquisitionJobCommonInputModal';
import AcquisitionJobAnnualInputModal from '@/components/payroll/social_insurance/modal/AcquisitionJobAnnualInputModal';
import AcquisitionJobHealthInputModal from '@/components/payroll/social_insurance/modal/AcquisitionJobHealthInputModal';
import AcquisitionJobEmploymentInputModal from '@/components/payroll/social_insurance/modal/AcquisitionJobEmploymentInputModal';
import AcquisitionJobIndustrialAshInputModal from '@/components/payroll/social_insurance/modal/AcquisitionJobIndustrialAshInputModal';


export default {
    mixins: [grid],
    components: {
        AcquisitionJobCommonInputModal,
        AcquisitionJobAnnualInputModal,
        AcquisitionJobHealthInputModal,
        AcquisitionJobEmploymentInputModal,
        AcquisitionJobIndustrialAshInputModal
    },    
    data() {
        return {
            fields: [],
    ...
    methods: {
        ...
        async loadGridData() {
            try {
                ...
                {
                    SI_REGIST_MATTER_NO: this.SI_REGIST_MATTER_NO,
                    QRY_RRN: 'YES'
                });
        ...
        gotoList() {
            this.$router.push({name: 'AcquisitionJob'});
        },
        ...
        setRealGridOptions: function() {
            ...
            this.SI_REGIST_MATTER_NO = this.$route.params.SI_REGIST_MATTER_NO || 'M003';
