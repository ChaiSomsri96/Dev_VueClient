<template>
  <div>
    ...
    <div class="content-body">
      ...
      <sev-pension-calc-result-tab></sev-pension-calc-result-tab>
...
import SevPensionCalcResultTab from "./SevPensionCalcResultTab";

export default {
  components:{
    ButtonPanel,
    SevPensionCalcResultTab
  },
  ...
  computed: {
    ...mapGetters({
      ...
      BONUS_DATA: 'sevpayentry/getBonusData'
    })
  },
  data() {
    return {
  ...
  methods: {
    ...
    saveMatter: function(){
      ...
      let cal = me.checkData( me.CAL_DATA);
      let avg = me.checkData( me.AVG_DATA);
      let ten = me.checkData( me.TEN_DATA);
      ...
      me.$httpPost({
        ...
        url: '/payroll/multiretirement/multi-retirepesion/save_pop',
        callback: function() {
          me.toastSuccessSave();
        }
      });
    ...
    setColumns(){
      ...
      let pSevProgType = me.SET_DATA[0].SEV_RPEN_RATE_TYPE;
      let pWorkText = '';
      ...
      me.columns.push( { fieldName: 'EID', header: '', visible: false});
      me.fields.push( { fieldName: 'EID', dataType: 'text'});
      switch ( pSevProgType) {
        case 'P':
          me.columns.push(
