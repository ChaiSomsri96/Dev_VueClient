<template>
    <div>
        ...
        <div class="content-body">
            ...
            <div>
                <div id="bizinc-income-query-grid" class="realgrid-type-style" style="width: 100%; height: 440px;"></div>
            </div>
        </div>
    </div>
</template>
<script>
    ...
    export default {
        ...
        data() {
            return {
                ...
                columns: [
                    ...
                    {fieldName: 'BIZ_TYPE', header: '업종구분', width: 100, styleName: "left-column"},
                    ...
                    {fieldName: 'PAY_MONTH', header: '귀속월', width: 100, datetimeFormat: "yyyy.MM.dd"},
        ...
        mounted() {
            this.createRealGrid({
                'domId': 'bizinc-income-query-grid',
                autoLoad: false
            });
