<template>
    <div>
        ...
        <div class="content-body">
            ...
            <div>
                <div id="bizinc-non-resid-query-grid" class="realgrid-type-style" style="width: 100%; height: 440px;"></div>
            </div>
        </div>
    </div>
</template>
<script>
    ...
    export default {
        ...
        mounted() {
            this.createRealGrid({
                'domId': 'bizinc-non-resid-query-grid',
                autoLoad: false
            });
