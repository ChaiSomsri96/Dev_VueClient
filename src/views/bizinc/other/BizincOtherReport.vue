<template>
    <div>
        ...
        <div class="content-body">
            ...
            <div>
                <div id="other-report-grid" class="realgrid-type-style" style="width: 100%; height: 440px;"></div>
            </div>

            <!--출력 팝업-->
            <bizinc-report-modal ref="bizincReportModal" :options="this.searchOptionData"/>
        </div>
    </div>
</template>
<script>
    ...
    export default {
        ...
        methods: {
            async loadGridData() {
                try {
                    const {data} = await this.$httpGet( '/bizinc/ext-income/selectEarnerExtIncome', {
                        ATT_YEAR: '2021'
                    });
